...
- **P1 — ChatbotService Make Studio tool-schema residual audit (gap 9)**: core registry/dispatch is
  ...
  object params (`ca7fcf9`). Primitive operation aliases such as `rectangular_prism`, `cuboid`, `rod`,
  and whitespace-separated variants are covered by `f90f7ea` and `be166d6`.
