...
public sealed class QuoteEngineSourceTests
{
    ...
    public void QuoteAgentLaunchShell_has_monochrome_chatgpt_like_contract()
    {
        ...
        Assert.Contains("text-align: right;", ExtractSourceBlock(agentStyles, ".qe-agent-search-prompt", ".qe-agent-search-prompt::after"), StringComparison.Ordinal);
        ...
        Assert.Contains("BeginDictationFromHoldAsync", composerScript, StringComparison.Ordinal);
        Assert.Contains("ToggleDictationAsync", composerScript, StringComparison.Ordinal);
