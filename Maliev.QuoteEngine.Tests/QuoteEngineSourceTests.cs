...
public sealed class QuoteEngineSourceTests
{
    ...
    public void Appearance_settings_persist_full_theme_profile_contract()
    {
        ...
        Assert.Contains("Theme mode, colors, UI font, and contrast.", shell, StringComparison.Ordinal);

        Assert.Contains("PreferenceService.SystemTheme", appearance, StringComparison.Ordinal);
        Assert.Contains("new(PreferenceService.SystemTheme, \"Auto\", \"อัตโนมัติ\", \"System\", \"ระบบ\")", appearance, StringComparison.Ordinal);
        Assert.Contains("new(PreferenceService.LightTheme, \"Light\", \"สว่าง\", \"Light profile\", \"โปรไฟล์สว่าง\")", appearance, StringComparison.Ordinal);
        Assert.Contains("new(PreferenceService.DarkTheme, \"Dark\", \"มืด\", \"Dark profile\", \"โปรไฟล์มืด\")", appearance, StringComparison.Ordinal);
        ...
        Assert.DoesNotContain("@Text(\"Code font\", \"ฟอนต์โค้ด\")", appearance, StringComparison.Ordinal);
        Assert.DoesNotContain("@Text(\"Translucent sidebar\", \"แถบด้านข้างโปร่งแสง\")", appearance, StringComparison.Ordinal);
        Assert.Contains("@Text(\"Contrast\", \"คอนทราสต์\")", appearance, StringComparison.Ordinal);
        Assert.Contains("appearance-mode-preview-frame", appearance, StringComparison.Ordinal);
        Assert.Contains("appearance-font-select", appearance, StringComparison.Ordinal);
        Assert.DoesNotContain("CodeFontChoices", appearance, StringComparison.Ordinal);
        Assert.DoesNotContain("appearance-toggle", appearance, StringComparison.Ordinal);
        ...
        Assert.DoesNotContain("appearance-studio-preview", appearance, StringComparison.Ordinal);
        Assert.DoesNotContain("Codex", appearance, StringComparison.Ordinal);
        Assert.Contains("<option value=\"make-studio\">Make Studio</option>", appearance, StringComparison.Ordinal);
        ...
        Assert.Contains("function applyContrastVariables", loader, StringComparison.Ordinal);
        Assert.Contains("root.removeAttribute(\"data-maliev-sidebar-translucent\")", loader, StringComparison.Ordinal);

        Assert.Contains(".appearance-theme-modes", styles, StringComparison.Ordinal);
        Assert.Contains(".appearance-mode-preview-frame", styles, StringComparison.Ordinal);
        Assert.DoesNotContain(".appearance-studio-preview", styles, StringComparison.Ordinal);
        ...
        Assert.Contains(".appearance-color-input input::-webkit-color-swatch-wrapper", styles, StringComparison.Ordinal);
        Assert.Contains("--maliev-theme-surface-foreground-mix", styles, StringComparison.Ordinal);
        Assert.DoesNotContain(".appearance-toggle", styles, StringComparison.Ordinal);
        Assert.DoesNotContain(":root[data-maliev-sidebar-translucent=\"true\"] .qe-agent-rail", styles, StringComparison.Ordinal);
    }

    [Fact]
    public void QuoteEngine_typography_uses_noto_sans_for_english_and_thai()
    {
        ...
        Assert.DoesNotContain("font-family:ui-monospace", viewer, StringComparison.Ordinal);
    }
    ...
    public void New_quote_workspace_uses_chat_first_agent_shell_for_anonymous_start()
    {
        ...
        Assert.Contains("ProfileDisplayName=\"@ProfileDisplayName\"", source, StringComparison.Ordinal);
        Assert.Contains("ProfileEmail=\"@ProfileEmail\"", source, StringComparison.Ordinal);
        Assert.Contains("ProfileImageUrl=\"@ProfileImageUrl\"", source, StringComparison.Ordinal);
        Assert.Contains("ProfileTier=\"@ProfileTier\"", source, StringComparison.Ordinal);
    ...
    public void QuoteAgentLaunchShell_has_monochrome_chatgpt_like_contract()
    {
        ...
        Assert.Contains("class=\"qe-agent-rail-search\"", primaryNav, StringComparison.Ordinal);
        Assert.Contains("qe-agent-global-search", primaryNav, StringComparison.Ordinal);
        Assert.Contains("qe-agent-global-search", component, StringComparison.Ordinal);
        Assert.Contains("@onfocus=\"OnSearchFocusAsync\"", component, StringComparison.Ordinal);
        Assert.Contains("@onmouseenter=\"SuppressSearchPromptOnHover\"", component, StringComparison.Ordinal);
        Assert.Contains("@onmouseleave=\"ResumeSearchPromptAfterHover\"", component, StringComparison.Ordinal);
        Assert.Contains("@onpointerenter=\"SuppressSearchPromptOnHover\"", component, StringComparison.Ordinal);
        Assert.Contains("@onpointerleave=\"ResumeSearchPromptAfterHover\"", component, StringComparison.Ordinal);
        Assert.Contains("placeholder=\"@SearchInputPlaceholder\"", component, StringComparison.Ordinal);
        Assert.Contains("class=\"qe-agent-search-prompt\"", component, StringComparison.Ordinal);
        Assert.Contains("SearchPromptExamples", component, StringComparison.Ordinal);
        Assert.Contains("AnimateSearchPromptAsync", component, StringComparison.Ordinal);
        Assert.Contains("CanAnimateSearchPrompt", component, StringComparison.Ordinal);
        ...
        Assert.Contains("private const int SearchMinimumCharacters = 3;", component, StringComparison.Ordinal);
        Assert.Contains("private bool SearchHasMinimumQuery", component, StringComparison.Ordinal);
        Assert.Contains("if (!SearchHasMinimumQuery)", component, StringComparison.Ordinal);
        ...
        Assert.Contains("_driveConnectorModalMode", component, StringComparison.Ordinal);
        Assert.Contains("OpenDriveConnectorModal", component, StringComparison.Ordinal);
        Assert.Contains("CloseDriveConnectorModal", component, StringComparison.Ordinal);
        Assert.Contains("ContinueToGoogleDriveAsync", component, StringComparison.Ordinal);
        Assert.Contains("DisconnectGoogleDriveAsync", component, StringComparison.Ordinal);
        Assert.Contains("connector.IsConfigured", component, StringComparison.Ordinal);
        Assert.Contains("myaccount.google.com/permissions", component, StringComparison.Ordinal);
        Assert.Contains("Connect Google Drive", component, StringComparison.Ordinal);
        ...
        Assert.Contains("ReportDictationErrorAsync", component, StringComparison.Ordinal);
        Assert.Contains("DictationStartedAsync", component, StringComparison.Ordinal);
        Assert.Contains("BeginDictationProcessingAsync", component, StringComparison.Ordinal);
        Assert.Contains("CompleteDictationAsync", component, StringComparison.Ordinal);
        ...
        Assert.Contains("Icons.Material.Filled.Stop", component, StringComparison.Ordinal);
        ...
        Assert.Contains(".qe-agent-search-prompt", agentStyles, StringComparison.Ordinal);
        Assert.Contains("text-align: left;", ExtractSourceBlock(agentStyles, ".qe-agent-search-prompt", ".qe-agent-search-prompt::after"), StringComparison.Ordinal);
        Assert.Contains("white-space: nowrap;", ExtractSourceBlock(agentStyles, ".qe-agent-search-prompt", ".qe-agent-search-prompt::after"), StringComparison.Ordinal);
        ...
        Assert.Contains("DisconnectGoogleDriveAsync", apiClient, StringComparison.Ordinal);
        Assert.Contains("quote/v1/connectors/google-drive/disconnect", apiClient, StringComparison.Ordinal);
        Assert.Contains(".qe-agent-connector-modal {", agentStyles, StringComparison.Ordinal);
        ...
        Assert.Contains("value.includes(\"\\n\") || isComposerTextWrapped(textarea, value)", composerScript, StringComparison.Ordinal);
        Assert.Contains("function isComposerTextWrapped", composerScript, StringComparison.Ordinal);
        Assert.Contains("getComputedStyle(composer).gridTemplateColumns", composerScript, StringComparison.Ordinal);
        ...
        Assert.Contains("grid-template-rows: auto 34px;", agentStyles, StringComparison.Ordinal);
        Assert.Contains("grid-template-rows: auto auto 34px;", agentStyles, StringComparison.Ordinal);
        ...
        Assert.Contains("export async function beginDictation", composerScript, StringComparison.Ordinal);
        Assert.Contains("export async function endDictation", composerScript, StringComparison.Ordinal);
        Assert.Contains("startDictationFromUserAction(textarea, dictationButton, dotNetRef)", composerScript, StringComparison.Ordinal);
        Assert.Contains("finishDictationFromUserAction(textarea, dotNetRef)", composerScript, StringComparison.Ordinal);
        Assert.Contains("invokeMethodAsync(\"DictationStartedAsync\")", composerScript, StringComparison.Ordinal);
        ...
        Assert.Contains("InvokeVoidAsync(\"setComposerText\", _composerTextarea, fullText)", component, StringComparison.Ordinal);
        Assert.Contains("Api.CleanSpeechAsync(rawText, language)", component, StringComparison.Ordinal);
        ...
        Assert.Contains("bars[index].style.opacity = (0.40 + value * 0.60).toFixed(2);", composerScript, StringComparison.Ordinal);
        ...
        Assert.Contains("function clearDictationLevel", composerScript, StringComparison.Ordinal);
        Assert.Contains("audioContext.resume()", composerScript, StringComparison.Ordinal);
        Assert.Contains("function reportDictationError", composerScript, StringComparison.Ordinal);
        Assert.Contains("invokeMethodAsync(\"ReportDictationErrorAsync\"", composerScript, StringComparison.Ordinal);
        Assert.Contains("reportDictationError(session, event.error", composerScript, StringComparison.Ordinal);
        ...
        Assert.Contains("border-radius: 16px;", agentStyles, StringComparison.Ordinal);
        ...
        Assert.Contains(".qe-agent-dictation-preview-final", agentStyles, StringComparison.Ordinal);
        Assert.Contains(".qe-agent-composer[data-dictation-active] .qe-agent-dictation-preview", agentStyles, StringComparison.Ordinal);
        ...
        Assert.Contains(".qe-agent-composer[data-dictation-level=\"good\"]", agentStyles, StringComparison.Ordinal);
        Assert.Contains(".qe-agent-composer[data-dictation-level=\"loud\"]", agentStyles, StringComparison.Ordinal);
        ...
        Assert.DoesNotContain("top: 50%;", ExtractSourceBlock(agentStyles, ".qe-agent-add-menu", ".qe-agent-add-menu button"), StringComparison.Ordinal);
        Assert.Contains("class=\"qe-agent-preview-modal\"", component, StringComparison.Ordinal);
        ...
        Assert.Contains("BuildUploadedPreviewItem(SelectedPartIndex, SelectedUploadedPart)", component, StringComparison.Ordinal);
        ...
        Assert.Contains(".qe-agent-preview-modal", agentStyles, StringComparison.Ordinal);
        Assert.Contains(".qe-agent-preview-backdrop", agentStyles, StringComparison.Ordinal);
        Assert.Contains(".qe-agent-preview-nav--prev", agentStyles, StringComparison.Ordinal);
        ...
        Assert.Contains(".qe-agent-account-panel", agentStyles, StringComparison.Ordinal);
        Assert.Contains(".qe-agent-user-avatar img", agentStyles, StringComparison.Ordinal);
        Assert.Contains(".qe-agent-signin-row", agentStyles, StringComparison.Ordinal);
        Assert.DoesNotContain(".qe-agent-signin-card", agentStyles, StringComparison.Ordinal);
        Assert.DoesNotContain(".qe-agent-signin-panel", agentStyles, StringComparison.Ordinal);
        Assert.Contains("width: min(730px, calc(100% - 32px));", agentStyles, StringComparison.Ordinal);
    ...
    [Fact]
    public void QuoteAgentLaunchShell_streams_structured_thinking_steps_from_quote_notifications_hub()
    {
        var component = ReadRepoFile("Maliev.QuoteEngine.Client", "Components", "QuoteAgent", "QuoteAgentLaunchShell.razor");

        Assert.Contains("@using Microsoft.AspNetCore.SignalR.Client", component, StringComparison.Ordinal);
        Assert.Contains("private HubConnection? _notificationConnection;", component, StringComparison.Ordinal);
        Assert.Contains("new HubConnectionBuilder()", component, StringComparison.Ordinal);
        Assert.Contains("Navigation.ToAbsoluteUri(\"/hubs/quote-notifications\")", component, StringComparison.Ordinal);
        Assert.Contains(".WithAutomaticReconnect()", component, StringComparison.Ordinal);
        Assert.Contains(".On<QuoteAgentThinkingStepDto>(\"QuoteAgentThinkingStep\"", component, StringComparison.Ordinal);
        Assert.Contains("ApplyStreamingThinkingStep(step)", component, StringComparison.Ordinal);
        Assert.Contains("InvokeAsync(\"JoinQuoteSessionGroup\", SessionId)", component, StringComparison.Ordinal);
        Assert.Contains("InvokeAsync(\"LeaveQuoteSessionGroup\", _joinedQuoteSessionId.Value)", component, StringComparison.Ordinal);
        Assert.Contains("await _notificationConnection.DisposeAsync();", component, StringComparison.Ordinal);
    }
    ...
    public void QuoteAgentLaunchShell_previews_attachments_until_customer_sends_message()
    {
        ...
        Assert.DoesNotContain("I am reading these into the quote workspace.", component, StringComparison.Ordinal);
        ...
        Assert.DoesNotContain(".qe-agent-composer-attachment-heading", styles, StringComparison.Ordinal);
        Assert.DoesNotContain(".qe-agent-composer-attachment-notice", styles, StringComparison.Ordinal);
        Assert.Contains(".qe-agent-composer-attachments::-webkit-scrollbar", styles, StringComparison.Ordinal);
    ...
    [Fact]
    public void QuoteAgentLaunchShell_renders_sent_user_attachments_outside_neutral_message_bubble()
    {
        var component = ReadRepoFile("Maliev.QuoteEngine.Client", "Components", "QuoteAgent", "QuoteAgentLaunchShell.razor");
        var styles = ReadRepoFile("Maliev.QuoteEngine.Client", "wwwroot", "css", "app.css").ReplaceLineEndings("\n");
        var threadBlock = ExtractSourceBlock(component, "<div class=\"qe-agent-thread\"", "<section class=\"@ComposerWrapClass\"");
        var userBubbleStyleBlock = ExtractSourceBlock(styles, ".qe-agent-message--user .qe-agent-bubble p {", ".qe-agent-message-sketch-preview");

        Assert.Contains("qe-agent-message-stack", threadBlock, StringComparison.Ordinal);
        Assert.Contains("class=\"qe-agent-message-attachments\"", threadBlock, StringComparison.Ordinal);
        Assert.Contains("MessageAttachmentClass(attachment)", threadBlock, StringComparison.Ordinal);
        Assert.Contains("class=\"qe-agent-message-footer\"", threadBlock, StringComparison.Ordinal);
        Assert.Contains("FormatMessageTime(message.CreatedAt)", threadBlock, StringComparison.Ordinal);
        Assert.Contains("CopyUserMessageAsync(message)", threadBlock, StringComparison.Ordinal);
        ...
        Assert.Contains("color: var(--qe-agent-ink) !important;", userBubbleStyleBlock, StringComparison.Ordinal);
    ...
    public void QuoteWorkspace_PushesRegisteredUploadAgentStateIntoMakeStudioShell()
    {
        ...
        Assert.Contains("private AgentWorkbenchSnapshot? _stateWorkbench;", shell, StringComparison.Ordinal);
        Assert.Contains("?? _stateWorkbench", shell, StringComparison.Ordinal);
        Assert.Contains("_stateWorkbench = BuildRestoredWorkbench(state);", shell, StringComparison.Ordinal);
        Assert.Contains("private AgentWorkbenchSnapshot? BuildRestoredWorkbench(QuoteAgentStateResponse state)", shell, StringComparison.Ordinal);
    ...
    public void QuoteAgentLaunchShell_renders_a_compact_deduplicated_workbench_before_the_selected_preview()
    {
        ...
        Assert.Contains("@onclick=\"@(() => SelectWorkbenchAttachment(attachment))\"", workbenchSection, StringComparison.Ordinal);
        Assert.Contains("@onclick=\"@(() => SelectWorkbenchAttachment(sketch))\"", workbenchSection, StringComparison.Ordinal);
        Assert.DoesNotContain("@onclick=\"@(() => OpenSketchPreview(sketch))\"", workbenchSection, StringComparison.Ordinal);
        ...
        Assert.Contains("@onkeydown=\"HandleWorkbenchUploadKeyDownAsync\"", drawer, StringComparison.Ordinal);
        ...
        Assert.Contains("if (artifact.ArtifactId != Guid.Empty)", shell, StringComparison.Ordinal);
        Assert.Contains("return $\"artifact:{artifact.ArtifactId:D}\";", shell, StringComparison.Ordinal);
        ...
        Assert.Contains("else if (selectedWorkbenchAttachment is not null && selectedWorkbenchAttachmentPreview is not null)", drawer, StringComparison.Ordinal);
    ...
    public void QuoteAgentLaunchShell_status_dot_uses_backend_health_not_composer_errors()
    {
        ...
        Assert.DoesNotContain("_error", statusBlock, StringComparison.Ordinal);
        Assert.DoesNotContain("is-failed", statusBlock, StringComparison.Ordinal);
    }

    [Fact]
    public void QuoteAgentComposer_space_shortcut_requires_hold_delay_before_starting_dictation()
    {
        var script = ReadRepoFile("Maliev.QuoteEngine.Client", "wwwroot", "js", "quote-agent-composer.js");
        var keydownBlock = ExtractSourceBlock(script, "const documentKeydown = async event =>", "const documentKeyup = async event =>");

        Assert.Contains("KeyboardDictationHoldDelayMs", script, StringComparison.Ordinal);
        Assert.Contains("keyboardHoldPending", script, StringComparison.Ordinal);
        Assert.Contains("keyboardHoldTimer = window.setTimeout(async () =>", keydownBlock, StringComparison.Ordinal);
        Assert.DoesNotContain("await startDictationFromUserAction(textarea, dictationButton, dotNetRef);", keydownBlock, StringComparison.Ordinal);
    }
    ...
    public void QuoteAgentLaunchShell_RendersSupplementalUploadsAsContextArtifacts()
    {
        ...
        Assert.Contains("BuildUploadedPreviewItem(SelectedPartIndex, SelectedUploadedPart)", drawer, StringComparison.Ordinal);
        Assert.Contains("IsPdfPreview(uploadedPreviewItem)", drawer, StringComparison.Ordinal);
        Assert.Contains("class=\"qe-agent-artifact-frame\"", drawer, StringComparison.Ordinal);
        Assert.Contains(".qe-agent-artifact-context", styles, StringComparison.Ordinal);
    }

    [Fact]
    public void QuoteAgentLaunchShell_uses_single_preview_surface_for_selected_artifacts()
    {
        var shell = ReadRepoFile("Maliev.QuoteEngine.Client", "Components", "QuoteAgent", "QuoteAgentLaunchShell.razor");
        var styles = ReadRepoFile("Maliev.QuoteEngine.Client", "wwwroot", "css", "app.css");
        var drawer = ExtractSourceBlock(shell, "qe-agent-artifact-drawer", "</aside>");
    ...
    public void QuoteWorkspaceRazor_has_no_demo_route_or_workspace_reset()
    {
        ...
        Assert.DoesNotContain("ShowLaunchAccountCard", src, StringComparison.Ordinal);
    ...
    [Fact]
    public void ReplicadWorker_handles_nullable_edge_operation_targets_without_dereferencing_null()
    {
    ...
    [Fact]
    public void QeInlinePartViewer_disposes_preview_when_commands_are_cleared()
    {
        var component = ReadRepoFile("Maliev.QuoteEngine.Client", "Components", "QuoteAgent", "QeInlinePartViewer.razor")
            .ReplaceLineEndings("\n");

        Assert.Contains("if (string.IsNullOrWhiteSpace(CommandsJson))", component, StringComparison.Ordinal);
        Assert.Contains("if (_renderedCommandsJson is not null)", component, StringComparison.Ordinal);
        Assert.Contains("await JS.InvokeVoidAsync(\"quoteInlineViewer.disposePreview\", _containerId);", component, StringComparison.Ordinal);
        Assert.Contains("_renderedCommandsJson = null;", component, StringComparison.Ordinal);
        Assert.Contains("_loadFailed = false;", component, StringComparison.Ordinal);
    }
